...
[安盛转保]
产品码：AS20220429
计划码：年缴:AS2022042901,月缴:AS2022042902;
[安盛转保(新保/续保)]
产品码：AS2023021603
计划码：年缴:AS202302160301,月缴:AS202302160302;
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "AS2022042902",  # 计划代码;
                    "IssueDate": CO.Time(),  # 出单时间      (注:不可倒签)
                    "EffectiveDate": CO.Tomorrow(day=1),  # 生效时间
                    "ExpireDate": CO.SeveralYears(day=1),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别类型
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "2988.84",  # 总保费
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "140302197504106637",  # 证件号/企业编号
                        "BirthDate": "19750410000000",  # 出生日期 投保类型为2非必传
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "249.07",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "249.07"  # 分期保费
                    }
                ]
            },
