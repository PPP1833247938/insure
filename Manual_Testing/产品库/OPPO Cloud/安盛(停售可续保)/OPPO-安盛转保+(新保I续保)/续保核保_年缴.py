...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "21010000H27230001530",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "AS202302160301",  # 计划代码  续保计划码(年:AS202302160301、月:AS202302160302)
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "530925199801073666",  # 证件号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "530925199801073666",  # 证件号
