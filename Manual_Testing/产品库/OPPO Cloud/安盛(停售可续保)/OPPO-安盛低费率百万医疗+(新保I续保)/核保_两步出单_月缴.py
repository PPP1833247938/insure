...
[安盛低费率百万医疗]
产品码：AS20220711
计划码：尊贵款基础版年缴:AS202207110301,尊贵款基础版月缴:AS202207110302;尊贵款+特械年缴:AS202207110201,尊贵款+特械月缴:AS202207110202
[安盛低费率百万医疗(新保/续保)]
产品码：AS2023021604
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "AS20230216040202",  # 计划代码;(尊贵款+特械:AS20230216040202,尊贵基础款:AS20230216040102)
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "632700199801073735",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "37.23",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "37.23"  # 分期保费
                    }
                ]
            },
