...
"""
[安盛百万医疗]
产品码：AS20211223(已停售未对接)
计划码：年缴:AS2021122301,月缴:AS2021122302;
[安盛百万医疗(新保/续保)]
产品码：AS2023021601
计划码：年缴:AS202302160101,月缴:AS202302160102;
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "FaceAmount": "200000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "653100199801071053",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "41.75",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "41.75"  # 分期保费
                    }
                ]
            },
