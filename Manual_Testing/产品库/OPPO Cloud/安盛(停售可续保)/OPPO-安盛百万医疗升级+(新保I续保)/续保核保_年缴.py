...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "21010000H27230001579",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "AS20220408201",  # 计划代码 续保计划码(年:AS202302160201、月:AS202302160202)
                    "IssueDate": "20231207235959",  # 出单时间
                    "EffectiveDate": "20231208000000",  # 生效时间
                    "ExpireDate": "20241207235959",  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币种
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "502.00",  # 总保费
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "610922199801072322",  # 证件号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "610922199801072322",  # 证件号
