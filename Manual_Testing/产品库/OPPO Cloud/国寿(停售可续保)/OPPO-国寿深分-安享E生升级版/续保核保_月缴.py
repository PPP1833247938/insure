...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "6688032023440380026071",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "CLICL2022052002",  # 续保计划码
                    "IssueDate": "20241204000000",  # 出单时间
                    "EffectiveDate": "20241205000000",  # 生效时间
                    "ExpireDate": "20251204235959",  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币种
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "864.00",  # 总保费
                    "FaceAmount": "9005000.00",  # 保额
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "522723199801077735",  # 证件号
                ...
                "InstallmentList": [
                    {
                        ...
                        "InstallmentPremium": "72.00",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "72.00"  # 分期保费
                    }
                ]
            },
