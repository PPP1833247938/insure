        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "625.00",  # 总保费
                    "FaceAmount": "9005000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和  (保额不校验)
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "510800199801073336",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "510800199801073336",  # 证件号/企业编号
