...
"""
产品码：CLICL20220520
计划码：年缴:CLICL2022052001,月缴:CLICL2022052002
(保司生产环境不可出新单)
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "660.00",  # 总保费
                    "FaceAmount": "9005000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "510623199801077664",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "510623199801077664",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "55.00",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "55.00"  # 分期保费
                    }
                ]
            },
