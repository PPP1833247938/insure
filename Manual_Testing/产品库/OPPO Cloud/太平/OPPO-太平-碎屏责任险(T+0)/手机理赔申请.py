    ...
    def Claim_application(self):
        ...
        body = {
            "Data": {
                ...
                "DamageDate": "20240320235959",  # 出险时间
                "DamageDetail": "测试单,反正就是坏了!",  # 出险详细经历（包括故障原因）
                # "MaterialList": ["090920240322114437031"],  # 理赔材料Id列表 [“543534534”,”4324234234”]
                "RepairCompleteDate": "20240321235959",  # 维修完成时间
