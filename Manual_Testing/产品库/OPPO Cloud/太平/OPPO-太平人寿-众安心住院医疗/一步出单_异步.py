        ...
        body = {
            "Data": {
                "Policy": {
                    ...
                    "PlanCode": "TAIPING2023062904",  # 计划代码
                    "IssueDate": CO.Time(),  # 出单时间      (注:不可倒签)
                    "EffectiveDate": CO.Tomorrow(),  # 生效时间
                    "ExpireDate": CO.SeveralMonths(month=6),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "TotalPremium": "0",  # 总保费
                    "Currency": "CNY",  # 币别
                    "PaymentType": "4",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "FaceAmount": "1000000.00",  # 保额,注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "PolicyHolder": {
                    ...
                    "PHBirthDate": CO.Birthday("510902198601166603"),  # 出生日期 （投保人类型为2-企业时非必填）
                ...
                "InsuredList": [
                    {
                        ...
                        "Mobile": None,  # 手机号
                        "BirthDate": CO.Birthday("510902198601166603"),  # 出生日期
                        "Email": CO.Mailbox(),  # 邮箱
