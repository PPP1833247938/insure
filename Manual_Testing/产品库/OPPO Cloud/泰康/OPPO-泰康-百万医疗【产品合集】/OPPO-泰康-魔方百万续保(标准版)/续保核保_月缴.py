...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "H231226004398400108292",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "TK2023062102",  # 计划代码
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "610329199801071735",  # 证件号
                ...
                "InstallmentList": [
                    {
                        ...
                        "InstallmentPremium": "71.80",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "71.80"  # 分期保费
                    }
                ]
            },
