        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "TK202301170102",  # 计划代码;(标准版月缴：TK202301170102;降级版月缴：TK202301170202)
                    "IssueDate": CO.Time(),  # 出单时间
                    "EffectiveDate": CO.Tomorrow(30),  # 生效时间         注:该产品支持次日凌晨或T+30生效
                    "ExpireDate": CO.SeveralYears(day=30),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别类型
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "1051.20",  # 总保费
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "610329199801071735",  # 证件号/企业编号
                        "BirthDate": "19980107000000",  # 出生日期 投保类型为2非必传
                        "Mobile": "13479245686",  # 手机号投保类型为2非必传
                        "Email": None,  # 邮箱
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "87.60",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "87.60"  # 分期保费
                    }
                ]
            },
