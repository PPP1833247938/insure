...
"""
产品码:TK20230724
年缴:10w:TK202307241001,20w:TK202307242001,30w:TK202307243001
月缴:10w:TK202307241002,20w:TK202307242002,30w:TK202307243002
"""
        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "421000199801078714",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "421000199801078714",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "52.60",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "52.60"  # 分期保费
                    }
                ]
            },
