...
"""
产品码：TK20230818
计划码：10万款:TK202308181002,20万款:TK202308182002,30万款:TK202308183002
注:该产品不同年纪不同性别保费不一样
"""
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "420204199801078090",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "36.20",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "36.20"  # 分期保费
                    }
                ]
            },
