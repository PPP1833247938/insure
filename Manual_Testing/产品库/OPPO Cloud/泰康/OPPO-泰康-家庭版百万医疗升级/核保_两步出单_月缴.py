...
Birthday = CO.Birthday(newIdNum)
config = Config("config.ini")
"""
百万医疗（家庭单升级),产品码：TK20211207
计划码：年缴:1019A05G01,月缴:1019A05G02
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "838.80",  # 总保费
                    "FaceAmount": "50000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHBirthDate": Birthday,  # 出生日期 投保类型为2不传
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "BirthDate": Birthday,  # 出生日期 投保类型为2非必传
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "69.90",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "69.90"  # 分期保费
                    }
                ]
            },
