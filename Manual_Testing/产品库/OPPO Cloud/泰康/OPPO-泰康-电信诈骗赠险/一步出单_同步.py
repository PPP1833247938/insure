        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": CO.newIdNum(1998, 11, 25),  # 证件号
                    "PHTelephone": CO.Mobilephone(),  # 手机号（投保人类型为2-企业时非必填）
                    "PHBirthDate": CO.Birthday(CO.newIdNum(1998, 11, 25)),  # 出生日期 （投保人类型为2-企业时非必填）
                ...
                "InsuredList": [
                    {
                        ...
                        "IdType": "01",
                        # 证件类型01身份证,02户口簿,03护照,04军官证,05驾驶执照,06港澳返乡证,07台胞证,08出生证,09统一社会信用代码,10纳税人识别号,11其他)
                        "IdNumber": CO.newIdNum(1998, 11, 25),  # 证件号
                        "Mobile": None,  # 手机号
                        "BirthDate": CO.Birthday(CO.newIdNum(1998, 11, 25)),  # 出生日期
                        "Email": CO.Mailbox(),  # 邮箱
