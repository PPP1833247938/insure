...
"""
产品码：ZH20231208
计划码：年缴:ZH2023120801,月缴:ZH2023120802
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "ZH2023120802",  # 计划代码;
                    "IssueDate": CO.Time(),  # 出单时间      (注:可倒签)
                    "EffectiveDate": CO.Tomorrow(4),  # 生效时间
                    "ExpireDate": CO.SeveralYears(day=4),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别类型
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "516.00",  # 总保费
                    "FaceAmount": "1461000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "150304199801076378",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "150304199801076378",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "43.00",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "43.00"  # 分期保费
                    }
                ]
            },
