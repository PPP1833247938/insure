        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "FaceAmount": "1461000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和  (保额不校验)
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "511300199801070032",  # 证件号/企业编号
