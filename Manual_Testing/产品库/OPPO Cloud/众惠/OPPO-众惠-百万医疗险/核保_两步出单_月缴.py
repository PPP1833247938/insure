...
"""
产品码：ZH20231109
计划码：年缴:ZH2023110901,月缴:ZH2023110902
"""
        ...
        body = {
            "Data": {
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "623024199801079186",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "623024199801079186",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "67.20",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "67.20"  # 分期保费
                    }
                ]
            },
