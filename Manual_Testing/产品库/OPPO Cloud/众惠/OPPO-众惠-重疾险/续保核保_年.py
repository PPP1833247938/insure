...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "P10E120230101V0020902",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "ZH2023120401",  # 续保计划码
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "650106199801079544",  # 证件号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "650106199801079544",  # 证件号
