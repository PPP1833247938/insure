...
"""
产品码：ZH20231204
计划码：年缴:ZH2023120401,月缴:ZH2023120402
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "278.00",  # 总保费
                    "FaceAmount": "140000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和  (保额不校验)
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "530128199801075763",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "530128199801075763",  # 证件号/企业编号
                ...
                #         "InstallmentPremium": "195",  # 对应分期号的保费，当前产品固定为首期保费
                #         "EachPremium": "195"  # 分期保费
                #     }
                # ]
            },
