...
续保
产品码：RB20220824
计划码：年缴:RB2022082401,月缴:RB2022082402
"""
...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "PWC320234403Q000F00083",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "RB2022082402",  # 续保计划码
                    ...
                    "TotalPremium": "866.16",  # 总保费
                    "FaceAmount": "21018000.00",  # 保额
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "513329199801074548",  # 证件号
                ...
                "InstallmentList": [
                    {
                        ...
                        "InstallmentPremium": "72.18",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "72.18"  # 分期保费
                    }
                ]
            },
