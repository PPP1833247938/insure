...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "PWC320234403Q000F00081",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "RB2022082401",  # 续保计划码
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "530422199801073846",  # 证件号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "530422199801073846",  # 证件号
