...
产品码：RB20220211
计划码：
年缴:RB20220211101(3w款),RB20220211201(10w款),RB20220211301(50w款),RB20220211401(100w款)
月缴:RB20220211102(3w款),RB20220211202(10w款),RB20220211302(50w款),RB20220211402(100w款)
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "314.64",  # 总保费
                    "FaceAmount": "1000000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "26.22",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "26.22"  # 分期保费
                    }
                ]
            },
