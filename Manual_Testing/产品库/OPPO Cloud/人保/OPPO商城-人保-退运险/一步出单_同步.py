        ...
        body = {
            "Data": {
                "Policy": {
                    ...
                    "EffectiveDate": CO.Time(),  # 生效时间
                    "ExpireDate": CO.TomorrowPresently(90),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                ...
                "Extension": {  # 拓展信息
                    "DeliveryInfo": {  # 货运信息(非必填),退运险必传
                        ...
                        "SigningTime": CO.Time(),  # 签收时间 yyyyMMddHHmmss
                        "OrderNO": CO.RandomStr().create(),  # 大订单号，存在多个订单时的的父订单号
                        "SubOrderNo": [CO.RandomStr().create(), CO.RandomStr().create()],  # 小订单号
                    }
                }
            },
