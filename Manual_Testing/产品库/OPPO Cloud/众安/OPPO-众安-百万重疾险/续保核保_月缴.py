...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "IH1100014625880680",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "ZAN202302272002",  # 续保计划代码
                    ...
                    "TotalPremium": "324.00",  # 总保费
                    "FaceAmount": "200000.00",  # 保额
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "511421199801073054",  # 证件号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "27.00",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "27.00"  # 分期保费
                    }
                ]
            },
