        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "810.00",  # 总保费
                    "FaceAmount": "500000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "67.50",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "67.50"  # 分期保费
                    }
                ]
            },
