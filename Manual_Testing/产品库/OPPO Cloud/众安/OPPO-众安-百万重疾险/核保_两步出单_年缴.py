        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "1400.00",  # 总保费
                    "FaceAmount": "500000",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "511011198807083211",  # 证件号/企业编号
                        "BirthDate": "19880708000000",  # 出生日期 投保类型为2非必传
