...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "IH1100014625870944",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "ZAN202302271001",  # 续保计划代码
                ...
                "PolicyHolder": {
                    ...
                    "PHIdNumber": "500240199801076234",  # 证件号
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "500240199801076234",  # 证件号
