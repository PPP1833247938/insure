        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "EffectiveDate": CO.Tomorrow(day=8),  # 生效时间               # 注:T+8,(测试环境支持倒签)
                    "ExpireDate": CO.SeveralYears(day=8, year=2),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "110.40",  # 总保费
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "4.60",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "4.60"  # 分期保费
                    }
                ]
            },
