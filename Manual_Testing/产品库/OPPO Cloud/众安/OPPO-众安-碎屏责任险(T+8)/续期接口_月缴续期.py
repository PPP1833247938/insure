...
class Renewal:
    ...
    def Renewal(self):
        ...
        body = {
            "Data": {
                "AgencyPolicyRef": "TenSerAy4yuByqm1",  # 第三方订单号
                "PlanCode": "ZAN2022021802",  # 保险计划代码
                ...
                "InstallmentPremium": "23.40",  # 分期产品，期次保费
                "OriginalPolicyRef": "PI07306240463627447823"  # 需要续期的保单号码
            },
