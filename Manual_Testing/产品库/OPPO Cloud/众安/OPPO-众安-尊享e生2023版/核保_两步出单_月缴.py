                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "210421199801074354",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "49.00",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "49.00"  # 分期保费
                    }
                ]
            },
