...
"""
产品码:ZAN20221227
计划代码:年缴:ZAN2022122701,月缴:ZAN2022122702
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "ZAN2022122701",  # 计划代码;
                    "IssueDate": "20221123235959",  # 出单时间      (注:可倒签)
                    "EffectiveDate": "20221124000000",  # 生效时间
                    "ExpireDate": "20231123235959",  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别类型
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "920.0",  # 总保费
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "510902198612156179",  # 证件号/企业编号
                        "BirthDate": "19861215000000",  # 出生日期 投保类型为2非必传
