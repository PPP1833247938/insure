...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "IH1100014646381321",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "ZAN2022122701",  # 续保计划代码
                ...
                "PolicyHolder": {
                    ...
                    "PolicyHolderName": "卢林",  # 用户姓名
                    "PHIdType": "01",
                    # 证件类型01居民身份证,02户口簿,03护照,04军官证,05驾驶执照,06港澳返乡证,07台胞证,08出生证,09统一社会信用代码,10纳税人识别号,11其他) 特殊说明下必传
                    "PHIdNumber": "510902198612156179",  # 证件号
                    "PHBirthDate": "19861215000000",  # 出生日期
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "510902198612156179",  # 证件号
                        "BirthDate": "19861215000000",  # 出生日期
