        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "TotalPremium": "332.04",  # 总保费
                    "FaceAmount": "30000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "510121199212021013",  # 证件号/企业编号
                        "BirthDate": "19921202000000",  # 出生日期 投保类型为2非必传
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "27.67",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "27.67"  # 分期保费
                    }
                ]
            },
