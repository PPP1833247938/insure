...
"""
计划代码:年缴:HT2023032401,月缴:HT2023032402
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "HT2023032402",  # 计划代码
                    "IssueDate": CO.Time(),  # 出单时间
                    "EffectiveDate": CO.Tomorrow(),  # 生效时间   (支持即时生效)
                    "ExpireDate": CO.SeveralYears(year=2),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别
                    "PaymentType": "2",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "46.80",  # 总保费
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        "InstallmentNum": "24",  # 分期数，如月缴12期
                        "InstallmentNo": "1",  # 分期号，按照约定传值；只有首期保费核保的产品，分期号固定值为1
                        "InstallmentPremium": "1.95",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "1.95"  # 分期保费
                    }
                ]
            },
