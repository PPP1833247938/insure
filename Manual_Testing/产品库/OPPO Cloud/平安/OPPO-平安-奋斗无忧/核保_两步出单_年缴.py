        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "PINGAN2021090201",  # 计划代码;
                    ...
                    "FaceAmount": "7046000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和  (保额不校验)
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "360900199801079030",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "360900199801079030",  # 证件号/企业编号
