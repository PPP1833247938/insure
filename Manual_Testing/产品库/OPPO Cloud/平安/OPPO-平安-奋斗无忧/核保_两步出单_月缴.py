...
"""
产品码：PINGAN20210902
计划码：年缴:PINGAN2021090201,月缴:PINGAN2021090202
"""
        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "PINGAN2021090202",  # 计划代码;
                    ...
                    "TotalPremium": "894.00",  # 总保费
                    "FaceAmount": "7046000.00",  # 保额注：1、保额可批增为初始保额2、医疗险多种条款为保额之和
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "451221199801075191",  # 证件号/企业编号
                ...
                "InstallmentList": [  # 分期信息列表，缴费方式为月缴PaymentType=2时必填
                    {
                        ...
                        "InstallmentPremium": "74.50",  # 对应分期号的保费，当前产品固定为首期保费
                        "EachPremium": "74.50"  # 分期保费
                    }
                ]
            },
