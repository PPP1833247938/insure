...
class Renew_insurance:
    ...
    def Renew_insurance(self):
        ...
        body = {
            "Data": {
                "Policy": {
                    "OriginalPolicyRef": "10560006600520036091",  # 原保单号
                    "AgencyPolicyRef": CO.RandomStr().create(),  # 第三方订单号
                    "PlanCode": "PINGAN2021090201",  # 续保计划码
                    "IssueDate": "20241227000000",  # 出单时间
                ...
                "InsuredList": [
                    {
                        ...
                        "IdNumber": "510727199801075600",  # 证件号
