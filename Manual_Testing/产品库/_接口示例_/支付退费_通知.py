...
class Payment_refund:
    ...
    def Payment_refund(self):
        ...
        body = {
            "Data": {
                "AgencyPolicyRef": "X33k9ChHoc9cGk6s",  # 第三方渠道公司保单号码或者第三方渠道公司订单号码
                "PolicyRef": "P10E120230101X1013703",  # 保单号
                "InstallmentNo": "1",  # 分期号(兼容资金安全险非必填),非分期产品默认为第一期
                "TotalPremium": "52.40",  # 保费，分期产品为对应期数保费
                "Currency": "CNY",  # 币别
                ...
                "PaymentFlowNum": CO.RandomStr().create(),  # (非必填)
