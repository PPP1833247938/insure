        ...
        body = {
            "Data": {
                "Policy": {  # 保单信息
                    ...
                    "PlanCode": "TK2023100901",  # 计划代码;
                    "IssueDate": CO.Time(),  # 出单时间
                    "EffectiveDate": CO.Tomorrow(30),  # 生效时间               注:本产品支持次日零时生效或T+30生效
                    "ExpireDate": CO.SeveralYears(day=30),  # 失效时间
                    "GroupSize": "1",  # 被保人个数
                    "Currency": "CNY",  # 币别类型
                    "PaymentType": "1",  # 缴费方式：1-年缴2-月缴3-趸缴4-免缴
                    "TotalPremium": "100.0",  # 总保费
                ...
                "PolicyHolder": {  # 投保人信息
                    ...
                    "PHIdNumber": "622925199801076473",  # 证件号/企业编号
                ...
                "InsuredList": [  # 被保人信息列表
                    {
                        ...
                        "IdNumber": "622925199801076473",  # 证件号/企业编号
